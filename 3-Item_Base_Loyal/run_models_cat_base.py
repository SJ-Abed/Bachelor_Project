...
plt.savefig('FI_CB_tot\FI_LogR2.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, abs(importance))
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot\FI_GNB2.JPEG', dpi=300)
plt.show()
...
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot\FI_DT.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot\FI_RF.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot\FI_ET.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot\FI_ADA.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot\FI_XGB.JPEG', dpi=300)
plt.show()
