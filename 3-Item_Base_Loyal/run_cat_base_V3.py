...
X_res.to_csv('X_res_v3.csv')
y_res.to_csv('y_res_v3.csv')
...
plt.savefig('FI_CB_tot_V3\FI_LogR2.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, abs(importance))
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_V3\FI_GNB2.JPEG', dpi=300)
plt.show()
...
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_V3\FI_DT.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_V3\FI_RF.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_V3\FI_ET.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_V3\FI_ADA.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_V3\FI_XGB.JPEG', dpi=300)
plt.show()
