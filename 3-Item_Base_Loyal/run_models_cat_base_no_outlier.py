...
# X_res = pd.read_csv('X_res_v2_no_outlier.csv', index_col=0)
# y_res = pd.read_csv('y_res_v2_no_outlier.csv', index_col=0)

train_validation_merge = pd.read_csv('train_validation_merge_v2_no_outlier.csv', index_col=0)
test_validation_merge = pd.read_csv('test_validation_merge_v2_no_outlier.csv', index_col=0)
...
X_res.to_csv('X_res_v2_no_outlier.csv')
y_res.to_csv('y_res_v2_no_outlier.csv')
...
plt.savefig('FI_CB_tot_no_outlier\FI_LogR2.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, abs(importance))
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_no_outlier\FI_GNB2.JPEG', dpi=300)
plt.show()
...
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_no_outlier\FI_DT.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_no_outlier\FI_RF.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_no_outlier\FI_ET.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_no_outlier\FI_ADA.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_CB_tot_no_outlier\FI_XGB.JPEG', dpi=300)
plt.show()
