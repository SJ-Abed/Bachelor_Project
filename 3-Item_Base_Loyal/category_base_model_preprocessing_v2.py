...
orders_df = orders_df[orders_df['cid'].isin(customer_order_count[customer_order_count >= least_order_limit].index)]
...
line_tracker.append(f'line 158\nprior_data_n_1 = {len(prior_data_n_1)}\nprior_data_n_2 = {len(prior_data_n_2)}\nprior_data_n_3 = {len(prior_data_n_3)}\n')
# Generate Features
...
line_tracker.append(f'line 229\nuser_features_n_1 = {len(user_features_n_1)}\nuser_features_n_2 = {len(user_features_n_2)}\nuser_features_n_3 = {len(user_features_n_3)}\n')
...
line_tracker.append(f'line 425\ncat_features_n_1 = {len(cat_features_n_1)}\ncat_features_n_2 = {len(cat_features_n_2)}\ncat_features_n_3 = {len(cat_features_n_3)}\n')
...
line_tracker.append(f'line 429\nuser_cat_features_n_1 = {len(user_cat_features_n_1)}\nuser_cat_features_n_2 = {len(user_cat_features_n_2)}\nuser_cat_features_n_3 = {len(user_cat_features_n_3)}\n')
...
line_tracker.append(f'line 503\ntest_days_since_prior = {len(test_days_since_prior)}\ntrain_days_since_prior = {len(train_days_since_prior)}\ntrain_days_since_prior_2 = {len(train_days_since_prior_2)}\n')
...
line_tracker.append(f'line 522\ntest_days_since_prior = {len(test_days_since_prior)}\ntrain_days_since_prior = {len(train_days_since_prior)}\ntrain_days_since_prior_2 = {len(train_days_since_prior_2)}\n')
line_tracker.append(f'line 523\ntest_validation_data = {len(test_validation_data)}\ntest_days_since_prior = {len(test_days_since_prior)}')
...
test_validation_merge = test_validation_merge.merge(class_day(test_days_since_prior), how='left',
                                                    on=['classid', 'day_of_week'])
################################
line_tracker.append(f'line 594\ntrain_validation_merge_1 = {len(train_validation_merge_1)}\ntrain_validation_merge_2 = {len(train_validation_merge_2)}\ntest_validation_merge = {len(test_validation_merge)}\n')
...
#############################
line_tracker.append(f'line 682\ntrain_validation_merge_1 = {len(train_validation_merge_1)}\ntrain_validation_merge_2 = {len(train_validation_merge_2)}\ntest_validation_merge = {len(test_validation_merge)}\n')
...
line_tracker.append(f'line 694\ntrain_validation_merge_1 = {len(train_validation_merge_1)}\ntrain_validation_merge_2 = {len(train_validation_merge_2)}\ntest_validation_merge = {len(test_validation_merge)}\n')
...
line_tracker.append(f'line 701\ntrain_validation_merge_1 = {len(train_validation_merge_1)}\ntrain_validation_merge_2 = {len(train_validation_merge_2)}\ntest_validation_merge = {len(test_validation_merge)}\n')
...
line_tracker.append(f'line 706\ntrain_validation_merge_1 = {len(train_validation_merge_1)}\ntrain_validation_merge_2 = {len(train_validation_merge_2)}\ntest_validation_merge = {len(test_validation_merge)}\n')
...
line_tracker.append(f'line 717\ntrain_validation_merge_1 = {len(train_validation_merge_1)}\ntrain_validation_merge_2 = {len(train_validation_merge_2)}\ntest_validation_merge = {len(test_validation_merge)}\n')
