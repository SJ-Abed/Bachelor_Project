...
plt.savefig('FI_IB_LCh\FI_LogR.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_IB_LCh\FI_GNB.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_IB_LCh\FI_DT.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_IB_LCh\FI_RF.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_IB_LCh\FI_ET.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_IB_LCh\FI_ADA.JPEG', dpi=300)
plt.show()
...
plt.bar(columns, importance)
plt.xticks(rotation=3 * 90)
plt.savefig('FI_IB_LCh\FI_XGB.JPEG', dpi=300)
plt.show()
